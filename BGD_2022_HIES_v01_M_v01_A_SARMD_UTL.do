...
* EXPENDITURES 1 (MONTHLY EXPENSES)
tempfile expenditures1
datalibweb, country(BGD) year(2022) type(SARRAW) surveyid(BGD_2022_HIES_v01_M) filename(HH_SEC_9C.dta) clear 
...
* EXPENDITURES 2 (ANNUAL EXPENSES)
...
****************************************************************************************************
* VARIABLES FROM SARMD IND MODULE
tempfile IND
use "$rootdatalib\\`code'\\`yearfolder'\\`SARMDfolder'\Data\Harmonized\\BGD_2022_HIES_v01_M_v01_A_SARMD_IND.dta", clear
sort  hhid pid
save `IND', replace //62,013 id, 14304 hh
...
egen  hhid = concat(PSU HHID), punct(-)
sort  hhid
save `housing', replace //14,395

* EXPENDITURES 1 (MONTHLY EXPENSES)
tempfile expenditures1
use  "$rootdatalib\\`code'\\`yearfolder'\\`yearfolder'_v`vm'_M\Data\Stata\HH_SEC_9C.dta", clear
keep if S9CQ00==44111 | S9CQ00==44211 | S9CQ00==44311 | S9CQ00==44411 | S9CQ00==44412 | S9CQ00==45111 | S9CQ00==45211 | S9CQ00==45212 | S9CQ00==45213 | S9CQ00==45311 | S9CQ00==45411 | S9CQ00==45412 | S9CQ00==45413 | S9CQ00==45414 | S9CQ00==45415 | S9CQ00==45419 | S9CQ00==72211 | S9CQ00==72212 | S9CQ00==72213 | S9CQ00==72214 | S9CQ00==72215 | S9CQ00==72216 | S9CQ00==83011 | S9CQ00==83012 | S9CQ00==83013 | S9CQ00==83014
...
egen  hhid = concat(PSU HHID), punct(-)
sort  hhid
save `expenditures1', replace //14243

* EXPENDITURES 2 (ANNUAL EXPENSES)
tempfile expenditures2
use  "$rootdatalib\\`code'\\`yearfolder'\\`yearfolder'_v`vm'_M\Data\Stata\HH_SEC_9D1.dta", clear
keep if S9D1Q02==43111 | S9D1Q02==43112 | S9D1Q02==43113 | S9D1Q02==43114 | S9D1Q02==43115 | S9D1Q02==43116 | S9D1Q02==43117 | S9D1Q02==43118 | S9D1Q02==43119 | S9D1Q02==431110 | S9D1Q02==431199| S9D1Q02==43211 | S9D1Q02==43212 | S9D1Q02==43213 | S9D1Q02==43214 | S9D1Q02==43215 | S9D1Q02==43219
rename S9D1Q05 S9D1Q05_
keep PSU HHID S9D1Q02 S9D1Q05_
reshape wide S9D1Q05_, j(S9D1Q02) i(PSU HHID)
...
egen  hhid = concat(PSU HHID), punct(-)
sort  hhid
save `expenditures2', replace //3302 obs
*/

* Merge raw modules
use `housing', clear //14,395
merge 1:1 hhid using `expenditures1' //14243
drop _merge
sort  hhid
merge 1:1 hhid using `expenditures2' //3302 obs
drop _merge
sort  hhid
merge 1:m hhid using `IND', keep(match) //14304 hh
drop _merge
sort  hhid
